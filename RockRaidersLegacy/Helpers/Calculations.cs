...
namespace RockRaiders.Core.Helpers
{
    ...
    {
        public static void cResponse(Vector2 position1, Vector2 position2,
        ...
        public static void cRecoil(
            Vector2 velocity1, ref Vector2 velocity2,
            float mass1, float mass2)
        {
            velocity2.X -= (mass2 * velocity1.X) / mass1;
            velocity2.Y -= (mass2 * velocity1.Y) / mass1;
        }
    }
}
